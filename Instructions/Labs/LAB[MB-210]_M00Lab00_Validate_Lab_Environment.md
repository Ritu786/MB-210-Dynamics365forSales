...
2.  Enter [your prefix ex. mollyc]+ SalesPractice for Name, Region and Type should be Default.  

3.  Create a database for this environment : **Yes** . Click on Next.

4.  Scroll Down to **Enable Dynamic 365 Apps** , Select Yes . In Automatically deploy these Apps, select **Sales Enterprise** 

5.  Click **Save**, Wait for few minutes to get Environment Ready.
